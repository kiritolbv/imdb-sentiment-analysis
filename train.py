...
print("=" * 60)
print("IMDb Sentiment Analysis - Version finale (92%+)")
print("=" * 60)

# 1. Chargement (40 000 critiques)
...
# 4. Modèle optimisé pour accuracy
...
config = {'input_dim': X_train.shape[1], 'max_features': 15000, 'samples': 40000}
